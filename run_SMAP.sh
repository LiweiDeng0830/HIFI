train_dir="/data/dlw/yichangjiance/BertAD/data/SMAP/train/"
test_dir="/data/dlw/yichangjiance/BertAD/data/SMAP/test/"
test_label_dir="/data/dlw/yichangjiance/BertAD/data/SMAP/test_label/"
d_word_vec=64
d_model=64
d_inner=128
n_layers=2
...
test_score_label_save_="./results/SMAP_dmodel_64_dinner_128_nlayers_2_dk_16_lr_0.005_epoch_100/"
device="cuda:2"
ad_size=25

files=$(ls ${train_dir})
#files=("machine-1-5.txt")
